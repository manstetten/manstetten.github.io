...
(window.webpackJsonp = window.webpackJsonp || []).push([[2], {
      ...
      if ("Element" in e) {
        var t = "classList",
          ...
          return s.call(e, t);
            ...
            c = function (e) {
          for (var t = r.call(e.getAttribute("class") || ""), n = t ? t.split(/\s+/) : [], o = 0, s = n.length; o < s; o++) this.push(n[o]);
        ...
        if (i.prototype = Error.prototype, l.item = function (e) {
          ...
          do {
            -1 === a(this, e = t[n] + "") && (this.push(e), r = !0);
          } while (++n < o);
          ...
          do {
            for (t = a(this, e = n[o] + ""); -1 !== t;) this.splice(t, 1), s = !0, t = a(this, e);
          } while (++o < r);
          ...
          try {
            o.defineProperty(n, t, h);
          } catch (p) {
            -2146823252 === p.number && (h.enumerable = !1, o.defineProperty(n, t, h));
          }
      ...
      if (e.classList.add("c1", "c2"), !e.classList.contains("c2")) {
        var t = function (e) {
          ...
          DOMTokenList.prototype[e] = function (e) {
            ...
            for (n = 0; n < o; n++) t.call(this, e = arguments[n]);
          };
        };
  ...
  "hN/g": function (e, t, n) {
    ...
    n.r(t), n("5yqK"), n("pDpN"), window.global = window;
  },
  pDpN: function (e, t, n) {
    var o, r;
    void 0 === (r = "function" == typeof (o = function () {
      ...
      !function (e) {
        ...
        class a {
          ...
          runTask(e, t, n) {
            ...
            try {
              ...
              e.state !== v && e.state !== S && (e.type == P || e.data && e.data.isPeriodic ? o && e._transitionTo(T, E) : (e.runCount = 0, this._updateTaskCount(e, -1), o && e._transitionTo(v, E, v))), z = z.parent, j = r;
            }
          }
          ...
          scheduleMicroTask(e, t, n, o) {
            return this.scheduleTask(new u(Z, e, t, n, o, void 0));
          }
        ...
        class l {
          ...
          scheduleTask(e, t) {
            ...
            if (this._scheduleTaskZS) this._hasTaskZS && n._zoneDelegates.push(this._hasTaskDlgtOwner), n = this._scheduleTaskZS.onScheduleTask(this._scheduleTaskDlgt, this._scheduleTaskCurrZone, e, t), n || (n = t);else if (t.scheduleFn) t.scheduleFn(t);else {
              if (t.type != Z) throw new Error("Task is missing scheduleFn.");
              m(t);
            }
            return n;
          }
        ...
        function S(e, o, s) {
          ...
          if (e[g] === v) {
            ...
            if (o !== T && s instanceof C && s.hasOwnProperty(g) && s.hasOwnProperty(_) && s[g] !== v) D(s), S(e, s[g], s[_]);else if (o !== T && "function" == typeof h) try {
              ...
              if (e[_] = s, e[m] === m && o === b && (e[g] = e[y], e[_] = e[k]), o === T && s instanceof Error) {
        ...
        if (n.patchThen = R, z) {
          R(z);
          const t = e.fetch;
          "function" == typeof t && (e[n.symbol("fetch")] = t, e.fetch = (L = t, function () {
            let e = L.apply(this, arguments);
      ...
      const d = Zone.__symbol__,
            ...
            _ = g ? window : void 0,
            m = g && _ || "object" == typeof self && self || global,
            k = [null];
      ...
      const b = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
            ...
            w = void 0 !== m.process && "[object process]" === {}.toString.call(m.process) && !b && !(!g || !_.HTMLElement),
            S = {},
            Z = function (e) {
      ...
      function D(n, o, r) {
        ...
        const a = s.get,
              ...
              l = o.substr(2);
        let u = S[l];
        u || (u = S[l] = d("ON_PROPERTY" + l)), s.set = function (e) {
          let t = this;
          t || n !== m || (t = m), t && (t[u] && t.removeEventListener(l, Z), c && c.apply(t, k), "function" == typeof e ? (t[u] = e, t.addEventListener(l, Z, !1)) : t[u] = null);
        }, s.get = function () {
          let e = this;
      ...
      function W(e, t, o) {
        ...
        function y(t, o) {
          ...
          const C = s ? function (e) {
            if (!E.isExisting) return w.call(E.target, E.eventName, E.capture ? k : m, E.options);
          } : function (e) {
            ...
            return function () {
              ...
              const m = M && !!R && -1 !== R.indexOf(f),
                    k = O(arguments[2], m);
              if (N) for (let e = 0; e < N.length; e++) if (f === N[e]) return m ? t.call(p, f, d, k) : t.apply(this, arguments);
              const y = !!k && ("boolean" == typeof k || k.capture),
                    v = !(!k || "object" != typeof k) && k.once,
                    w = Zone.current;
              let S = H[f];
              S || (B(f, b), S = H[f]);
              const Z = S[y ? l : u];
              ...
              const z = p.constructor.name,
                    I = F[z];
              I && (D = I[f]), D || (D = z + n + (b ? b(f) : f)), E.options = k, v && (E.options.once = !1), E.target = p, E.capture = y, E.eventName = f, E.isExisting = C;
              const L = s ? A : void 0;
              L && (L.taskData = E);
              const x = w.scheduleEventTask(D, d, L, r, a);
              return E.target = null, L && (L.taskData = null), v && (k.once = !0), (M || "boolean" != typeof x.options) && (x.options = k), x.target = p, x.capture = y, x.eventName = f, g && (x.originalDelegate = d), h ? P.unshift(x) : P.push(x), c ? p : void 0;
            };
          };

          return v[r] = L(w, g, C, z, y), P && (v.prependListener = L(P, ".prependListener:", function (e) {
            ...
            if (f) for (let e = 0; e < f.length; e++) {
              const o = f[e];
              if (j(o, a)) return f.splice(e, 1), o.isRemoved = !0, 0 === f.length && (o.allRemoved = !0, t[p] = null, "string" == typeof n) && (t[h + "ON_PROPERTY" + n] = null), o.zone.cancelTask(o), y ? t : void 0;
            }
            ...
            if (y) return this;
          }, I(v[r], w), I(v[a], S), D && I(v[p], D), Z && I(v[c], Z), !0;
        }
      ...
      function le(e, t, n, o) {
        ...
        r = z(e, t += o, n => function (r, s) {
          ...
          const r = o[0];
          let s;
          "number" == typeof r ? s = i[r] : (s = r && r[ce], s || (s = r)), s && "string" == typeof s.type ? "notScheduled" !== s.state && (s.cancelFn && s.data.isPeriodic || 0 === s.runCount) && ("number" == typeof r ? delete i[r] : r && (r[ce] = null), s.zone.cancelTask(s)) : t.apply(e, o);
        });
      }
      ...
      Zone.__load_patch("legacy", e => {
        ...
        o && o.prototype && n.patchEventTarget(e, [o.prototype]), C("MutationObserver"), C("WebKitMutationObserver"), C("IntersectionObserver"), C("FileReader");
        ...
        !function (e) {
          ...
          function k(e) {
            ...
            const h = i[r] = () => {
              if (i.readyState === i.DONE) if (!o.aborted && i[s] && e.state === m) {
            ...
            if (e[o]) return w.apply(e, n);
            {
              const t = {
                ...
                aborted: !1
                    ...
                    o = f("XMLHttpRequest.send", y, t, k, v);
              e && !0 === e[l] && !t.aborted && o.state === m && o.invoke();
            }
          }),
                S = z(h, "abort", () => function (e, o) {
            const r = e[n];

            if (r && "string" == typeof r.type) {
              if (null == r.cancelFn || r.data && r.data.aborted) return;
              r.zone.cancelTask(r);
            } else if (!0 === t.current[T]) return S.apply(e, o);
          });
        }(e);
        const n = d("xhrTask"),
              o = d("xhrSync"),
